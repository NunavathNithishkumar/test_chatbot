...
# Chat UI style (Updated to look like a messaging app)
st.markdown("""
    <style>
    .chat-container {
        max-width: 700px;
...
# Display chat history in a message app style
...
with st.container():
    query = st.text_input("Type your message:", key="user_input", max_chars=300, placeholder="Type a message...")    
    if st.button("Send", key="send_message") and query.strip():
